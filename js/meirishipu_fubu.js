...
$(function () {
        $.ajax({
            type: 'get',
            url: 'https://jinnianss.github.io/youeryuanj/json/meirishipu_fabu.json',
            ...
            success: function (data) {
                ...
                $("#banhao")[0].setAttribute("value",data.cookbookList[0].classlist.classid);
                ...
                $(data.cookbookList).each(function (index, value) {
                    ...
                    $(".xueke").append(
                        $("<label class='checkbox-inline'></label>").html(
                            "<input type='checkbox' id='inlineCheckbox'+index+' ' value='option'+index+' '>"+
                            this.typeName
                        )
